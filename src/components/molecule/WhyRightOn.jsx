...
function WhyRightOn() {
  return (
    <div className='card-wrapper-normal'>
      ...
      <h2><img src={circle} className='about-icons' alt='product feature' />Why <b><em>RightOn!</em></b></h2>
      <h3><b><em>RightOn!</em></b> is a free game show app that makes math more fun for middle and high school students.</h3>
      <div className='why-righton-wrapper'>
        ...
        <div className='why-righton-list'>
          ...
          The same high-quality, fun version of <b><em>RightOn!</em></b> is available for all students – no matter your school, zip code, or how much you even like math.
              </div>
      </div>
      <div className='why-righton-wrapper'>
        <div className='temp'>
